...
function xml(style) {
    ...
    return '<metadata' + ' xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"' + ' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"' + ' xmlns:dc="http://purl.org/dc/elements/1.1/"' + ' xmlns:dcterms="http://purl.org/dc/terms/">' + '<rdf:RDF>' + '<rdf:Description>' + (title ? `<dc:title>${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(title)}</dc:title>` : '') + (creator ? `<dc:creator>${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(creator)}</dc:creator>` : '') + (source ? `<dc:source xsi:type="dcterms:URI">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])((_g = (_f = style.meta) === null || _f === void 0 ? void 0 : _f.source) !== null && _g !== void 0 ? _g : '')}</dc:source>` : '') + (license ? `<dcterms:license xsi:type="dcterms:URI">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(license)}</dcterms:license>` : '') + (rights ? `<dc:rights>${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(rights)}</dc:rights>` : '') + '</rdf:Description>' + '</rdf:RDF>' + '</metadata>';
}
function text(style) {
...
function createAttrString(result) {
    ...
    return Object.keys(attributes).map((attr)=>`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(attr)}="${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$escape$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(attributes[attr])}"`).join(' ');
}
...
function createAvatar(style, options = {}) {
    ...
    if (options.scale !== undefined && options.scale !== 100) {
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addScale"])(result, options.scale);
    }
    if (options.flip) {
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addFlip"])(result);
    }
    if (options.rotate) {
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addRotate"])(result, options.rotate);
    }
    if (options.translateX || options.translateY) {
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addTranslate"])(result, options.translateX, options.translateY);
    }
    if (primaryBackgroundColor !== 'transparent' && secondaryBackgroundColor !== 'transparent') {
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addBackground"])(result, primaryBackgroundColor, secondaryBackgroundColor, backgroundType, backgroundRotation);
    }
    if (options.radius || options.clip) {
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addViewboxMask"])(result, (_e = options.radius) !== null && _e !== void 0 ? _e : 0);
    }
    if (options.randomizeIds) {
        // Reduces the occurrence of ID collisions when rendering multiple avatars on one HTML page.
        result.body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randomizeIds"])(result);
    }
    const attributes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$svg$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createAttrString"])(result);
    const metadata = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$utils$2f$license$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["xml"])(style);
...
"[project]/node_modules/@dicebear/core/lib/types.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$schema$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@dicebear/core/lib/schema.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$core$2f$lib$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@dicebear/core/lib/types.js [app-client] (ecmascript)");
;
;
;
;
...
"[project]/node_modules/@dicebear/core/lib/index.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@dicebear/initials/lib/index.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@dicebear/initials/lib/index.js [app-client] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "create": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"]),
    "meta": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["meta"]),
    "schema": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$schema$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["schema"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$schema$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@dicebear/initials/lib/schema.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@dicebear/initials/lib/index.js [app-client] (ecmascript) <locals>");
}}),
...
{
__turbopack_context__.s({
    "create": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["create"]),
    "meta": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["meta"]),
    "schema": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["schema"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/@dicebear/initials/lib/index.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dicebear$2f$initials$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/node_modules/@dicebear/initials/lib/index.js [app-client] (ecmascript) <exports>");
}}),
"[project]/node_modules/@dicebear/initials/lib/index.js [app-client] (ecmascript) <export * as initials>": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_a0dca8ed._.js.map